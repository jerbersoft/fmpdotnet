...
public sealed record IncomeStatementGrowth
{
    ...
    public decimal? GrowthEps { get; init; }
    ...
    public decimal? GrowthEpsDiluted { get; init; }
    ...
    public decimal? GrowthWeightedAverageSharesOutstanding { get; init; }
