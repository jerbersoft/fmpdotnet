...
- **`TreatWarningsAsErrors=true` and `GenerateDocumentationFile=true`.** A `<see cref="...">` pointing at a
  ...
  `<see cref>` in the task that creates it. **Task 4 promotes every deferred cref in this plan** and lists
  them by file and anchor.
...
## Three rulings carried into this plan
